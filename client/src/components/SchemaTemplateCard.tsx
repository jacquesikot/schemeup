  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography
          sx={{ fontSize: "14px", fontFamily: "Inter", lineHeight: "20px" }}
        >
          This is a full scale template description to help users understand
          more about the features and use cases of these templates.
        </Typography>
      </Box>
